...
为了方便理解，以下是项目中各个核心文件的功能解释：

| 文件名称 | 类型 | 功能详细说明 |
| :--- | :--- | :--- |
| **matlab2018b.slx** | 仿真模型 | 项目的主入口文件。包含了完整的 Simulink 框图（无人机物理模型、控制器模块、信号连接）。<br>**注意**：请使用 MATLAB 2018b 或更高版本打开。 |
...
| **基于前馈补偿...pdf** | 参考文献 | 项目所参考的原始论文，包含了控制律的数学推导、稳定性证明及理论参数，建议阅读以理解算法原理。 |
